...
#pragma region TransformMatrixResourced
	...
	//WVP用のリソースを作る
	transformMatrixResource = object3dCommon->GetDxCommon()->CreateBufferResource(sizeof(TransformationMatrix));
	//データを書き込む
...
#pragma region DirectionalLightData
	...
	directionalLightResource =
		object3dCommon->GetDxCommon()->CreateBufferResource(sizeof(DirectionalLight));
	//平行光源用にデータを書き込む
